  ...
  >
    ...
    <form @submit.prevent>
      ...
      <div class="flex justify-end mt-6">
        ...
        <button
          class="px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-[#2a2d57] rounded-md hover:bg-pink-700 focus:outline-none focus:bg-gray-600"
          id="delete"
        >
          Delete
        </button>
